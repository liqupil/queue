    ...
    public function safeUp()
    {
        ...
        $this->insert('{{%widget_menu}}', [
            ...
            'items' => json_encode([
                ...
                [
                    'label' => 'Kviku Queue on GitHub',
                    'url' => 'https://github.com/kviku_queue/kviku_queue',
                    'options' => ['tag' => 'span'],
                    'template' => '<a href="{url}" class="btn btn-lg btn-primary">{label}</a>'
                ],
                [
                    'label' => 'Find a bug?',
                    'url' => 'https://github.com/kviku_queue/kviku_queue/issues',
                    'options' => ['tag' => 'span'],
        ...
        $this->insert('{{%widget_text}}', [
            ...
            'body' => '<p>Welcome to Kviku Queue Dashboard</p>',
            'status' => 1,
            'created_at' => time(),
            'updated_at' => time(),
        ]);
